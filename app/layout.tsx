...
export const metadata: Metadata = {
  ...
  title: {
    default: "Hot & Cool Services | HVAC in Northern Virginia & DC",
    template: "%s | Hot & Cool Services",
  },
  description: "Professional HVAC repair, installation, maintenance, water heater, and duct services across Northern Virginia, Maryland, and Washington, DC.",
  icons: {
    icon: [{ url: images.favicon, type: "image/png", sizes: "256x256" }],
